 ...
 * |------+------+------+------+------+------+------+------+------+------+------+------|
 * | Brite| Ctrl | Alt  | GUI  |Space |Lower |Raise |AltGr |Moves |Funcs | Left |Right |
 * `-----------------------------------------------------------------------------------'
 */
[_QWERTY] = LAYOUT_planck_grid(
    ...
    BACKLIT, KC_LCTL, KC_LALT, KC_LGUI, KC_SPC,  LOWER,   RAISE,   KC_ALGR, MOVES,   FUNCS,   KC_LEFT, KC_RGHT
),
 ...
 * `-----------------------------------------------------------------------------------'
 */
[_MOVES] = LAYOUT_planck_grid(
    _______, _______, _______, _______, _______, _______, _______, KC_HOME, KC_END,  KC_INS,  KC_DEL,  _______,
